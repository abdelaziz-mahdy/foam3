...
foam.CLASS({
//   package: 'foam.demos.solarsystem',
  name: 'SolarSystem',
  ...
  methods: [
     ...
     function init() {
      ...
      this.space.addChild_(this.sun);
      this.space.addChild_(this.venus);
      this.space.addChild_(this.earth);
      this.space.addChild_(this.moon);
      this.space.addChild_(this.apollo);
      this.space.addChild_(this.mars);
