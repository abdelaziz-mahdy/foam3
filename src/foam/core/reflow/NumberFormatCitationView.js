...
foam.CLASS({
  package: 'foam.core.reflow',
  name: 'NumberFormatSelectionView',
...
foam.CLASS({
  package: 'foam.core.reflow',
  name: 'NumberFormatRichChoiceView',
  ...
  properties: [
    {
      name: 'selectionView',
      factory: function() {
        return { class: 'foam.core.reflow.NumberFormatSelectionView' };
      }
    },
    {
      name: 'rowView',
      factory: function() {
        return { class: 'foam.core.reflow.NumberFormatCitationView' };
      }
    },
    {
      name: 'sections',
