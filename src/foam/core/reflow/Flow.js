...
//      of: 'com.google.flow.Property',
      ...
      postSet: function(_, n) {
        var json = foam.json.Outputter.create({
          ...
          setTimeout(() => {
            this.lastMementoStrFromMemento_ = newStr;
    ...
    },
    {
      ...
      label: 'Script',
      postSet: function(_, n) {
        // Don't update if this change came from memento postSet
        if ( this.lastMementoStrFromMemento_ === n ) {
          this.lastMementoStrFromMemento_ = null; // Clear the tracking
          return;
        }
