...
foam.POM({
  ...
  files: [
    ...
    { name: "benchmark/DateFormatBenchmark",                          flags: "js|java" },
    { name: "benchmark/JournalReplayBenchmark",                       flags: "js|java" },
    { name: "benchmark/LoggingBenchmark",                             flags: "js|java" },
    { name: "benchmark/JSONOutputterEscapeBenchmark",                 flags: "js|java" },
    { name: "benchmark/FUIDBenchmark",                                flags: "js|java" },
    { name: "benchmark/TimestampBenchmark",                           flags: "js|java" },
    { name: "benchmark/JSONOutputterBenchmark",                       flags: "js|java" },
    { name: "benchmark/JSONUtilEscapeBenchmark",                      flags: "js|java" },
    { name: "benchmark/PMBenchmark",                                  flags: "js|java" },
    { name: "benchmark/F3FileJournalBenchmark",                       flags: "js|java" },
    { name: "benchmark/JSONFormatterBenchmark",                       flags: "js|java" },
    { name: "benchmark/F3JournalReplayBenchmark",                     flags: "js|java" },
    { name: "benchmark/FileJournalBenchmark",                         flags: "js|java" }
  ],
